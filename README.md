...
When you click play for the first time, you start with the Gravity Orb tool. You must try to survive while mining resources. But to mine resources, you must lure the enemies close and dodge them at the last second so they crash into asteroids. You can use those resources to craft tools that you have equipped. Destroying enemies and asteroids gives you coins which can be used to unlock tools.
